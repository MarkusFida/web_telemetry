...
$fields = [
    ...
    'gps_course', 'gps_speed', 'gps_sats', 'peak', 'valley', 'vario', 'temp', 'humidity', 'gps_time', 'ballast_drop', 'ballast_drop_count', 'sand_count', 'bag_count'
];
$values = [];
foreach ($fields as $f) {
...
$numericFields = [
    'qnh', 'alt_ft', 'alt_m', 'gps_alt', 'gps_lat', 'gps_lng',
    'gps_course', 'gps_speed', 'gps_sats', 'peak', 'valley', 'vario', 'temp', 'humidity', 'ballast_drop_count', 'sand_count', 'bag_count'
];
...
$sql = "INSERT INTO vario_data (
    ...
    peak, valley, vario, temp, humidity, gps_time, ballast_drop, ballast_drop_count, sand_count, bag_count, created_at
) VALUES (
    ...
    {$values['vario']}, {$values['temp']}, {$values['humidity']}, {$values['gps_time']}, {$values['ballast_drop']}, {$values['ballast_drop_count']}, {$values['sand_count']}, {$values['bag_count']}, UTC_TIMESTAMP()
)";
